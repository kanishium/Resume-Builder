...
const Features = () => {
  ...
  return (
    <div id="features" className="flex flex-col items-center scroll-mt-2">
...
elps you create a professional resume in minutes with intelligent
I-powered tools and features."
      />
